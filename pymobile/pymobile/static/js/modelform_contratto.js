...
//     
    ...
    // console.log("CIAO");
	// // var new_form = $("tr#empty_pianotarrifario:hidden").clone(true);
...
// var addDatoPTForm = function(j_obj){
	...
	// // var options = $("select#id_pianotariffario_set-0-tariffa");
	// // console.log(options);
	// // new_form.find("select#id_pianotariffario_set-__prefix__-tariffa").after(options);
	// new_form.find(":input").each(function(){
		// var id = $(this).attr("id");
		// var new_id = id.replace("__prefix__", forms_count);
		// $(this).attr("id", new_id);
...
// $(document).ready(function(){
	...
	// // });
	// var new_form = $("tr#empty_pianotarrifario:hidden").clone(true);
	// var empty_form = $("tr#empty_pianotarrifario:hidden");
	// var options = $("select#id_pianotariffario_set-0-tariffa option").not("[value='']");
	// console.log(options);

...
urlpatterns += patterns('django.views.generic.simple',
    url(r'^pymobile/$', "direct_to_template", {"template": "index.html"}),                       
)
...
urlpatterns += patterns('pymobile.administration.views',
   url(r'^pymobile/dipendente/$', "dipendente.admin.init", name="init_dipendente"),
   url(r'^pymobile/dipendente/add/$', "dipendente.admin.add_object", name="add_dipendente"),
   url(r'^pymobile/dipendente/mod/(?P<object_id>\d+)/$', "dipendente.admin.mod_object", name="mod_dipendente"),
   url(r'^pymobile/dipendente/del/$', "dipendente.admin.del_object", name="del_dipendente"),
   url(r'^pymobile/dipendente/(?P<object_id>\d+)/$', object_detail, INFO_DIP, 
       name="view_dipendente"),
   url(r'^pymobile/dipendente/(?P<object_id>\d+)/provvigione/$', 
       "dipendente.admin.init_provvigione", name="init_provvigione"),
   url(r'^pymobile/dipendente/(?P<object_id>\d+)/provvigione/add_retribuzione/$', 
       "dipendente.admin.add_retribuzione", name="add_retribuzione"),
   url(r'^pymobile/dipendente/(?P<object_id>\d+)/provvigione/add_vartmp/$', 
       "dipendente.admin.add_vartmp", name="add_vartmp"),
   url(r'^pymobile/dipendente/(?P<object_id>\d+)/provvigione/mod_retribuzione/(?P<provvigione_id>\d+)/$', 
       "dipendente.admin.mod_retribuzione", name="mod_retribuzione"),
   url(r'^pymobile/dipendente/(?P<object_id>\d+)/provvigione/mod_vartmp/(?P<provvigione_id>\d+)/$', 
       "dipendente.admin.mod_vartmp", name="mod_vartmp"),
   url(r'^pymobile/dipendente/(?P<object_id>\d+)/provvigione/del_retribuzione/$', 
       "dipendente.admin.del_retribuzione", name="del_retribuzione"),
   url(r'^pymobile/dipendente/(?P<object_id>\d+)/provvigione/del_vartmp/$', 
       "dipendente.admin.del_vartmp", name="del_vartmp"),                        
)

# tariffa
urlpatterns += patterns('pymobile.administration.views',
   url(r'^pymobile/tariffa/$', "tariffa.admin.init", name="init_tariffa"),
   url(r'^pymobile/tariffa/add/$', "tariffa.admin.add_object", name="add_tariffa"),
...
# cliente
urlpatterns += patterns('pymobile.administration.views',
   url(r'^pymobile/cliente/$', "cliente.admin.init", name="init_cliente"),
   url(r'^pymobile/cliente/add/$', "cliente.admin.add_object", name="add_cliente"),
   url(r'^pymobile/cliente/mod/(?P<object_id>\d+)/$', "cliente.admin.mod_object", name="mod_cliente"),
   url(r'^pymobile/cliente/del/$', "cliente.admin.del_object", name="del_cliente"),
   url(r'^pymobile/cliente/(?P<object_id>\d+)/$', object_detail, INFO_CLI, name="view_cliente"),
)

# appuntamento
urlpatterns += patterns('pymobile.administration.views',
   url(r'^pymobile/appuntamento/$', "appuntamento.admin.init", name="init_appuntamento"),
   url(r'^pymobile/appuntamento/add/$', "appuntamento.admin.add_object", name="add_appuntamento"),
   url(r'^pymobile/appuntamento/mod/(?P<object_id>\d+)/$', "appuntamento.admin.mod_object", 
       name="mod_appuntamento"),
   url(r'^pymobile/appuntamento/del/$', "appuntamento.admin.del_object", 
       name="del_appuntamento"),
   url(r'^pymobile/appuntamento/add/popup:add-(?P<field_name>\w+)/$', 
       "appuntamento.admin.add_child_object", name="add_fk"),
   url(r'^pymobile/appuntamento/(?P<object_id>\d+)/$', object_detail, INFO_APP, 
       name="view_appuntamento"),
   url(r'^pymobile/appuntamento/(?P<object_id>\d+)/mail/$', "appuntamento.admin.send_mail_to_agente", 
       name="send_mail_appuntamento"),
   url(r'^pymobile/appuntamento/assign/$', "appuntamento.admin.assign_object", 
       name="assign_appuntamento"),
   url(r'^pymobile/appuntamento/(?P<object_id>\d+)/referente/(?P<referente_id>\d+)/$', 
       "appuntamento.admin.view_referente", name="view_referente"), 
   url(r'^pymobile/appuntamento/(?P<object_id>\d+)/referente/(?P<referente_id>\d+)/mod/$', 
       "appuntamento.admin.mod_referente", name="mod_referente"), 
   url(r'^pymobile/appuntamento/(?P<object_id>\d+)/referente/del/$', 
       "appuntamento.admin.del_referente", name="del_referente"),
#   url(r'^pymobile/appuntamento/autocomplete/$', "appuntamento.admin.filter_lookup", 
#       name="filter_lookup"),    
)

# contratto
urlpatterns += patterns('pymobile.administration.views',
   url(r'^pymobile/contratto/$', "contratto.admin.init", name="init_contratto"),
   url(r'^pymobile/contratto/add/$', "contratto.admin.add_object", name="add_contratto"),
   url(r'^pymobile/contratto/mod/(?P<object_id>\d+)/$', "contratto.admin.mod_object", 
       name="mod_contratto"),
   url(r'^pymobile/contratto/del/$', "contratto.admin.del_object", 
       name="del_contratto"),
   url(r'^pymobile/contratto/add/popup:add-(?P<field_name>\w+)/$', 
       "contratto.admin.add_child_object", name="add_contratto_fk"),
   url(r'^pymobile/contratto/(?P<object_id>\d+)/$', object_detail, INFO_CON, 
       name="view_contratto"), 
)

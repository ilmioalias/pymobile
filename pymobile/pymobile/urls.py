...
#                            name="add_contratto"),
                        ...
                        url(r'^pymobile/contratto/add_info/(?P<object_id>\d+)/$', "contratto.admin.mod_object_info", 
                            name="mod_contratto_info"),
                        url(r'^pymobile/contratto/add_pt/(?P<object_id>\d+)/$', "contratto.admin.mod_object_pt", 

...
#                            name="add_contratto"),
                        ...
                        url(r'^pymobile/contratto/add_pt/(?P<object_id>\d+)/$', 
                            "contratto.admin.add_object_pt", 
                            name="add_contratto_pt"),
                        url(r'^pymobile/contratto/add_dati/(?P<object_id>\d+)/$', 
                            "contratto.admin.add_object_dati", 
                            name="add_contratto_dati"),
                        url(r'^pymobile/contratto/mod_info/(?P<object_id>\d+)/$', 
                            "contratto.admin.mod_object_info", 
                            name="mod_contratto_info"),
                        url(r'^pymobile/contratto/mod_pt/(?P<object_id>\d+)/$', 
                            "contratto.admin.mod_object_pt", 
                            name="mod_contratto_pt"),
                        url(r'^pymobile/contratto/mod_dati/(?P<object_id>\d+)/$', 
                            "contratto.admin.mod_object_dati", 
                            name="mod_contratto_dati"),

        ...
        for data in date:
            ...
            for contratto in contratti_day:
                ...
                for pt in pts:
                    ...
                    prov_agente = calc_provvigione(agente, cliente, tariffa, data)
                    out_tot_prov_agt_contratto += prov_agente[0]
                    out_tot_prov_bonus_agt_contratto += prov_agente[1]
                    # 2: provvigione dovuta al telefonista
                    prov_telefonista = calc_provvigione(telefonista, cliente, tariffa, data)
                    out_tot_prov_tel_contratto += prov_telefonista[0]
                    out_tot_prov_bonus_tel_contratto += prov_telefonista[1]
            ...
            obj_out = {"data": data, "n_stipulati": n, "uscite": out_tot_day,
...
def calc_provvigione(dipendente, cliente, tariffa, data):
